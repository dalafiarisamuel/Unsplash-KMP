...
val appDark
    @Composable @ReadOnlyComposable get() = MaterialTheme.colors.secondary

val colorDisabledGray
    @Composable @ReadOnlyComposable get() = MaterialTheme.colors.onSecondary

val colorGrayDivider
    @Composable @ReadOnlyComposable get() = MaterialTheme.colors.secondaryVariant

fun Color.complementary() = Color(red = 1F - red, green = 1F - green, blue = 1F - blue)
